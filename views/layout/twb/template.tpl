...
<!--  Menu dependiendo rol    --> 
            ...
            {if Session::get('resid') == "1" || Session::get('level') <= "6"}

            {if isset($_layoutParams.menu_vecino)}   

                <ul class="nav navbar-nav">

                   {foreach item=it from=$_layoutParams.menu_vecino}
           ...
           {if Session::get('autenticado')}
            ...
            {if isset($_layoutParams.menu_comite)}   

                <ul class="nav navbar-nav">

                   {foreach item=it from=$_layoutParams.menu_comite}
           ...
           {if Session::get('level') == "1"}
            ...
            {if isset($_layoutParams.menu_gestor)}   

                <ul class="nav navbar-nav">

                   {foreach item=it from=$_layoutParams.menu_gestor}
           ...
           {if Session::get('level') == "3"}
            ...
            {if isset($_layoutParams.menu_admin)}   

                <ul class="nav navbar-nav">

                   {foreach item=it from=$_layoutParams.menu_admin}
            ...
            {if isset($_layoutParams.menu_conserje)}   

                <ul class="nav navbar-nav">

                   {foreach item=it from=$_layoutParams.menu_conserje}
