...
--
-- Host: localhost    Database: covecino_bd
-- ------------------------------------------------------
...
--
-- Table structure for table `est_multa`
--

DROP TABLE IF EXISTS `est_multa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_multa` (
  `Id_estmul` int(11) NOT NULL AUTO_INCREMENT,
  `Nom_estmul` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`Id_estmul`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `est_multa`
--

LOCK TABLES `est_multa` WRITE;
/*!40000 ALTER TABLE `est_multa` DISABLE KEYS */;
INSERT INTO `est_multa` VALUES (1,'En deuda'),(2,'Pagada');
/*!40000 ALTER TABLE `est_multa` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `his_multa`
--

DROP TABLE IF EXISTS `his_multa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `his_multa` (
  `Id_hmul` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `his_multa`
--

LOCK TABLES `his_multa` WRITE;
/*!40000 ALTER TABLE `his_multa` DISABLE KEYS */;
INSERT INTO `his_multa` VALUES (4,'88888','2018-05-20 01:59:38','Creación',1,NULL,78000,NULL,1,'15028679-4',1),(5,'88888','2018-05-20 02:00:45','Edición',1,78000,79000,1,2,'15028679-4',1),(6,'88888','2018-05-20 02:01:23','Eliminación',1,79000,NULL,2,NULL,'15028679-4',1),(7,'55555','2018-05-21 00:40:30','Creación',2,NULL,780000,NULL,1,'15028679-4',1),(8,'55555','2018-05-21 00:51:27','Edición',1,780000,780000,1,1,NULL,0),(9,'44444','2018-05-21 00:52:39','Creación',1,NULL,45000,NULL,1,'15028679-4',1);
/*!40000 ALTER TABLE `his_multa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `his_obs`
--

DROP TABLE IF EXISTS `his_obs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `his_obs` (
  `Id_hobs` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `his_obs`
--

LOCK TABLES `his_obs` WRITE;
/*!40000 ALTER TABLE `his_obs` DISABLE KEYS */;
/*!40000 ALTER TABLE `his_obs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `multa` (
  ...
  UNIQUE KEY `Cod_multa` (`Cod_multa`),
  KEY `Id_usu` (`Id_usu`),
  KEY `Id_viv` (`Id_viv`),
  KEY `Id_tmul` (`Id_tmul`),
  KEY `Id_estmul` (`Id_estmul`)
...
INSERT INTO `multa` VALUES (4,'123','2018-05-19 16:01:00','2018-05-19','2018-05-20','Mal estacionado.',99999,12,1,2,1),(5,'1234','2018-05-19 16:05:29','2018-05-19','2018-05-20','Mal estacionado otra vez',99999,12,1,2,1),(6,'12345','2018-05-19 16:10:04','2018-05-19','2018-05-20','Otra vez mal estacionado por tercera vez.',99999,12,1,2,1),(7,'123456','2018-05-19 16:16:55','2018-05-19','2018-05-20','Otra vez mal estacionado por tercera vez, otra vez.',99998,12,1,2,1),(8,'13526','2018-05-19 16:18:12','2018-05-19','2018-05-20','Estacionado mal',989898,12,1,2,1),(10,'76346743','2018-05-19 16:43:06','2018-05-19','2018-05-20','Ejemplo Modal',989898,12,1,2,1),(11,'23123','2018-05-19 17:02:55','2018-05-22','2018-05-23','3123213',123213231,12,1,1,1),(12,'213213','2018-05-19 17:06:49','2018-05-18','2018-05-19','1232111',321231,12,1,2,2),(13,'777','2018-05-20 01:21:27','2018-05-20','2018-05-21','Mal estacionado dep. A101',23000,12,2,1,1),(14,'77777','2018-05-20 01:23:38','2018-05-20','2018-05-22','Ruidos molestos3',89070,12,1,2,2),(19,'55555','2018-05-21 00:40:30','2018-05-21','2018-05-28','Chocó portón',780000,12,1,1,1),(20,'44444','2018-05-21 00:52:39','2018-05-21','2018-05-21','Pelea en área común',45000,12,1,1,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_create_multa` AFTER INSERT ON `multa`
 FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_update_multa` BEFORE UPDATE ON `multa`
 FOR EACH ROW BEGIN
INSERT INTO his_multa
   ( Id_hmul,
     Cod_hmul,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_delete_multa` BEFORE DELETE ON `multa`
 FOR EACH ROW BEGIN
INSERT INTO his_multa
   ( Id_hmul,
     Cod_hmul,
...
INSERT INTO `observacion` VALUES (1,'2018-05-20 16:49:04','2018-05-20 23:48:44','Agresión a conserje1',1,12,1),(2,'2018-05-20 17:44:37','2018-05-20 00:00:00','Agresión a conserje',2,12,1),(3,'2018-05-20 19:01:04','0000-00-00 00:00:00','Robo en estacionamiento',2,12,1),(4,'2018-05-20 21:17:12','2018-05-20 21:16:00','Golpea portón visita',2,12,1),(5,'2018-05-20 22:48:38','2018-05-20 22:48:00','Robo camioneta, estacionamiento, sector sur',2,12,2);
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_create_obs` AFTER INSERT ON `observacion`
 FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_update_obs` BEFORE UPDATE ON `observacion`
 FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`covecino`@`localhost`*/ /*!50003 TRIGGER `his_delete_obs` BEFORE DELETE ON `observacion`
 FOR EACH ROW BEGIN
INSERT INTO his_obs
   ( Id_hobs,
     Id_obs,
...
INSERT INTO `reg_backup` VALUES (1,'2018-05-18 02:02:35','covecino_20180518-030233.sql','simpleSave',12),(2,'2018-05-18 02:02:58','covecino_20180518-030258.sql','save&download',12),(3,'2018-05-18 02:09:50','covecino_20180518-030950.sql','save&download',12),(4,'2018-05-18 02:10:54','covecino_20180518-031054.sql','save&download',12),(5,'2018-05-18 02:11:33','covecino_20180518-031133.sql','save&download',12),(6,'2018-05-18 02:14:08','covecino_20180518-031408.sql','save&download',12),(7,'2018-05-18 02:24:49','covecino_20180518-032449.sql','save&download',12),(8,'2018-05-18 02:26:16','covecino_20180518-032616.sql','save&download',12),(9,'2018-05-18 02:26:25','covecino_20180518-032625.sql','save&download',12),(10,'2018-05-18 02:30:56','covecino_20180518-033056.sql','save&download',12),(11,'2018-05-18 02:35:40','covecino_20180518-033540.sql','save&download',12),(12,'