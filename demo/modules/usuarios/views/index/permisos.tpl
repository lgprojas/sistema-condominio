...
<h4><strong>Usuario:</strong> {$info.Nom_usu}<br /><strong>Role:</strong> {$info.Nom_role}</h4>
<div class="col-lg-8">
<form name="form1" method="post" action="">
    ...
    {if isset($permisos) && count($permisos)}
        ...
        <p><a class="btn btn-default" href="{$_layoutParams.root}usuarios"><i title="Volver" class="glyphicon glyphicon-chevron-left">Volver</i></a>   <input class="btn btn-primary" type="submit" value="guardar"/></p>
        {/if}
</form>
</div>
</div>