...
class perModel extends Model{
    ...
    public function poseeYaRelVivPer($viv=false,$per=false,$trel=false){
    ...
    public function poseeYaRelVehiPer($vehi=false,$per=false,$trelv=false){
    ...
    public function eliminarPer($idper = false, $idcond = false){
        ...
        $this->_db->query("DELETE FROM persona " .
                          "WHERE Id_per=$id AND Id_cond = $cond");
    }
