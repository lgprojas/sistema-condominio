<?php /* Smarty version Smarty-3.1.11, created on 2018-05-27 13:26:18
         compiled from "/home/covecino/public_html/demo/views/layout/twb/template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12578994925b08f4070e2280-83832157%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc30627d80dc02b65fd343fe67e55e132d2d2642' => 
    array (
      0 => '/home/covecino/public_html/demo/views/layout/twb/template.tpl',
      1 => 1527438280,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12578994925b08f4070e2280-83832157',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5b08f4074c8dc4_07843716',
  'variables' => 
  array (
    'titulo' => 0,
    '_layoutParams' => 0,
...
<?php if ($_valid && !is_callable('content_5b08f4074c8dc4_07843716')) {function content_5b08f4074c8dc4_07843716($_smarty_tpl) {?><!DOCTYPE html>
...
"><?php echo $_smarty_tpl->tpl_vars['it3']->value['title'];?>
            ...
            <?php if (Session::get('resid')=="1"||Session::get('level')<="6"){?>

            <?php if (isset($_smarty_tpl->tpl_vars['_layoutParams']->value['menu_vecino'])){?>   

                <ul class="nav navbar-nav">

                   <?php  $_smarty_tpl->tpl_vars['it'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['it']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['_layoutParams']->value['menu_vecino']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['it']->key => $_smarty_tpl->tpl_vars['it']->value){
$_smarty_tpl->tpl_vars['it']->_loop = true;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['it3']->value['title'];?>
           ...
           <?php }?>            
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['_layoutParams']->value['menu_operador'])){?>   

                <ul class="nav navbar-nav">

                   <?php  $_smarty_tpl->tpl_vars['it'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['it']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['_layoutParams']->value['menu_operador']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['it']->key => $_smarty_tpl->tpl_vars['it']->value){
$_smarty_tpl->tpl_vars['it']->_loop = true;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['it3']->value['title'];?>
           ...
           <?php if (Session::get('autenticado')){?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['_layoutParams']->value['menu_comite'])){?>   

                <ul class="nav navbar-nav">

                   <?php  $_smarty_tpl->tpl_vars['it'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['it']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['_layoutParams']->value['menu_comite']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['it']->key => $_smarty_tpl->tpl_vars['it']->value){
$_smarty_tpl->tpl_vars['it']->_loop = true;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['it3']->value['title'];?>
           ...
           <?php if (Session::get('level')=="1"){?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['_layoutParams']->value['menu_sadmin'])){?>   

                <ul class="nav navbar-nav">

                   <?php  $_smarty_tpl->tpl_vars['it'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['it']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['_layoutParams']->value['menu_sadmin']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['it']->key => $_smarty_tpl->tpl_vars['it']->value){
$_smarty_tpl->tpl_vars['it']->_loop = true;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['it3']->value['title'];?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['_layoutParams']->value['menu_conserje'])){?>   

                <ul class="nav navbar-nav">

                   <?php  $_smarty_tpl->tpl_vars['it'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['it']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['_layoutParams']->value['menu_conserje']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['it']->key => $_smarty_tpl->tpl_vars['it']->value){
$_smarty_tpl->tpl_vars['it']->_loop = true;
?>
