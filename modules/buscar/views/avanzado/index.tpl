...
{if isset($dat) && !empty($dat)}
    ...
    <tbody>
        <tr>
            <td>RUN:</td><td>{$dat.Rut_per|upper}</td>   
        </tr>
        <tr>
        ...
        <tr>
            <td>Estado:</td><td>{if $dat.Id_estre == "1"}<p style="background: greenyellow;">{$dat.Nom_estre|upper}</p>{else}<p style="background: orange;">{$dat.Nom_estre|upper}</p>{/if}</td>   
        </tr>
        <tr>
            <td>Rel cond:</td><td>{$dat.Nom_act|upper}</td>   
        </tr>
        {if $select == "777"}
        <tr>
            <td>Condominio:</td><td>{$dat.Nom_cond|upper}</td>   
        </tr>
        {/if}
    </tbody> 
    </table>
...
{if isset($dat1) && !empty($dat1)}
    ...
    <tbody>
        ...
        <tr>
            <td>Estacionamiento:</td><td>{if isset($dat1) && !empty($dat1)}{$dat1.Nom_esta|upper}{/if}</td>
        </tr>
        <tr>
...
{if isset($dat2) && !empty($dat2)}
    ...
    <tbody>
        <tr>
            <td>Patente:</td><td>{$dat2.Cod_vehi|upper}</td>   
        </tr>
        <tr>
            <td>Marca:</td><td>{$dat2.Nom_marca|upper}</td>
        </tr>
        <tr>
            <td>Modelo:</td><td>{$dat2.Nom_modelo|upper}</td>
        </tr>
        <tr>
            <td>Detalle:</td><td>{$dat2.Desc_vehi}</td>   
        </tr>              
    </tbody> 
    </table>
{/if}
