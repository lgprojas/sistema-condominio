...
<table class="table table-bordered">
    <thead style="background: #E6E6FA;">
        ...
        {if $_acl->permiso('desasoc_viv_per')}<th style="text-align: center;">Quitar</th>{/if}
    </thead>
    ...
    {foreach item=ca from=$carga}
        <tr>
            ...
            {if $_acl->permiso('desasoc_viv_per')}<td style="text-align: center;"><a href="{$_layoutParams.root}transa/per/deleteVivRelPer/{$ca.Id_viv_encrypt}/{$Id_encrypt}" onclick='return dec(this);'><i title="Quitar de la lista" class="glyphicon glyphicon-trash"></i></a></td>{/if}            
        </tr>        
    {/foreach}
